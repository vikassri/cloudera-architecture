...
export const OS_OPTIONS = {
  rhel8: {
    label: "RHEL 8 / CentOS 8",
    kernel: "4.18.x",
    pkgMgr: "dnf / yum",
    defaultFS: "xfs",
    supportedFS: ["xfs", "ext4"],
    javaVersion: "OpenJDK 11",
    PythonVersion: "Python 3.8+",
    notes: "Cloudera recommended. SELinux must be disabled. Transparent Huge Pages (THP) disabled via tuned profile.",
    color: "text-green-400",
    bg: "bg-green-500/10",
    border: "border-green-500/30",
  },
  rhel9: {
    label: "RHEL 9 / CentOS 9",
    kernel: "5.14.x",
    pkgMgr: "dnf",
    defaultFS: "xfs",
    supportedFS: ["xfs", "ext4"],
    javaVersion: "OpenJDK 11 / 17",
    PythonVersion: "Python 3.8+",
    notes: "CDP 7.1.9+ required for RHEL 9 support. Verify Cloudera support matrix before deploying.",
    color: "text-green-400",
    bg: "bg-green-500/10",
    border: "border-green-500/30",
  },
  ubuntu20: {
    ...
    pkgMgr: "apt",
    defaultFS: "ext4",
    supportedFS: ["ext4", "xfs"],
    javaVersion: "OpenJDK 11",
    PythonVersion: "Python 3.8+",
    notes: "Supported from CDP 7.1.7+. AppArmor should be disabled. Use XFS for Hadoop data partitions.",
    color: "text-green-400",
    bg: "bg-green-500/10",
    border: "border-green-500/30",
  },
  ubuntu22: {
    ...
    javaVersion: "OpenJDK 11 / 17",
    PythonVersion: "Python 3.8+",
    notes: "Supported from CDP 7.1.9+. Verify support matrix. AppArmor must be disabled for CDP roles.",
    color: "text-green-400",
    bg: "bg-green-500/10",
    border: "border-green-500/30",
  },
  sles15: {
    ...
    javaVersion: "OpenJDK 11",
    PythonVersion: "Python 3.8+",
    notes: "Limited support. Verify with Cloudera support matrix. Rarely used in production CDP clusters.",
    color: "text-green-400",
    bg: "bg-green-500/10",
    border: "border-green-500/30",
  },
